...
if (isset($responseArray['business_discovery'])) {
    // Acesso seguro aos índices do array
    $profilePicture = $responseArray['business_discovery']['profile_picture_url'];
}
	...
	<body>
		...
		<div style="display:inline-block;width:100%">
			...
			<div style="float:left;margin-left:20px">
				...
				<div style="display:inline-block;margin-left:20px">
					<b><?php echo $responseArray['business_discovery']['ig_id']; ?></b> Account ID
				</div>
			</div>
		</div>
		<div>
